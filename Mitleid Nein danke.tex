...
\usepackage{float}
\usepackage[left=3cm,right=2cm,top=3.5cm,bottom=2.5cm]{geometry} % Seitenränder
...
% Kapitel-Layout anpassen: Abstände vor und nach Kapiteln festlegen
...
\RedeclareSectionCommand[
  % Anpassung des Inhaltsverzeichnisses für bessere Trennung der Ebenen
    tocindent=0pt,
...
\usepackage{footmisc}
\setlength{\footnotemargin}{0pt} % Sorgt für eine linksbündige Ausrichtung von Fußnoten ohne hängenden Einzug.
...
\setlength{\headsep}{1.5cm}  % Legt den Abstand zwischen Kopfzeile und Text fest
...
\tableofcontents
\clearpage         % Neue Seite nach Inhaltsverzeichnis

% Frontmatter-Kapitel: römische Seitenzahlen in Fußzeile, keine Kopfzeile
\addchap{Danksagung}
...
\begin{figure}[ht] % [htbp] sind Platzierungsoptionen: h=h
    ...
    \includegraphics[width=0.75\textwidth]{Fotos/ChristophMariaHerbst.jpg}
...
%     \parbox{\textwidth}{\raggedleft Quelle: Google Earth}}  
