...
% Kapitel-Layout anpassen: Abstände vor Kapiteln entfernen
...
\vspace*{-3\baselineskip}% Stärkerer negativer Abstand für chapterbox
\begin{chapterbox}
    Die ersten Jahre
\end{chapterbox}
...
\begin{figure}[H]
    ...
    \caption{Die Wahrscheinlichkeit, dass eine Mutter, die Trägerin ist, einen kranken Sohn auf die Welt bringt, beträgt 50~\%. Ebenso hoch ist die Wahrscheinlichkeit, dass ihre Tochter Trägerin ist.\\ \parbox{\textwidth}{\raggedleft Zeichnung: Peter Ebel}}
    \label{fig:vererbung}
\end{figure}
