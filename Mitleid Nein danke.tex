...
\RedeclareSectionCommand[tocindent=0pt, tocbeforeskip=0.4\baselineskip]{section}
\RedeclareSectionCommand[tocindent=1em, tocbeforeskip=0\baselineskip]{subsection}
...
\newtcolorbox{chapterbox}[1][]{
    ...
    width=\textwidth,
    arc=0pt,
    left=6pt, right=0pt, top=0.5cm, bottom=0.5cm,
    valign=center,
    fontupper=\normalfont\huge\rmfamily\color{white},
    halign=center,
    sharp corners,
    colback=chapterdarkblue!5!chapterlightblue!95,
    #1
}
