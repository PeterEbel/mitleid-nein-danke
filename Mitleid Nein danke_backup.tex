...
\usepackage{float}
\usepackage[left=3cm,right=2cm,top=3.5cm,bottom=3.5cm]{geometry} % Seitenränder

\setlength{\headsep}{1.5cm}  % Abstand zwischen Kopfzeile und Text fest
\setlength{\footskip}{1cm}   % Abstand zwischen Text und Fußzeile (für Seitenzahlen)
\setcounter{secnumdepth}{-1} % Deaktiviert die Nummerierung für alle Überschriften

\usepackage{polyglossia}
\setmainlanguage{german}
\setotherlanguage{english}
\hyphenation{Kran-ken-hau-ses Pro-dukt-de-signer Be-rufs-bil-dungs-werk We-ser-berg-land-Kli-nik Nord-rhein-West-fa-len}
...
% Kapitelüberschriften definieren
...
\RedeclareSectionCommand[
    ...
    tocindent=0pt,
    tocbeforeskip=0.4\baselineskip
  ]{section}
...
\RedeclareSectionCommand[
    ...
    % Anpassung der Verzeichnisüberschriften
    tocindent=1em,
    tocbeforeskip=0\baselineskip
]{subsection}

% Neuer Formatvorlagen-Befehl für Absatzüberschriften
\newcommand{\absatzueberschrift}[1]{%
  \vspace{1em}%
  {\noindent\textbf{\textcolor{myblue}{#1}}\par}
  \vspace{0.5em}%
}
...
\definecolor{rightcolumn}{RGB}{235,242,249}      % Hellblau für rechte Spalte
\definecolor{chapterdarkblue}{RGB}{47,84,150}    % Dunkelblau
\definecolor{chapterlightblue}{RGB}{198,217,241} % Hellblau

\usepackage{makecell}
\usepackage{footmisc}
\setlength{\footnotemargin}{0pt} % Linksbündige Ausrichtung von Fußnoten ohne hängenden Einzug.
...
\setsansfont{Frutiger LT 45 Light}
\setmonofont{Frutiger LT 45 Light}
...
\setkomafont{subsection}{\setstretch{0.9}\normalfont\fontsize{16}{20}\rmfamily\textcolor{myblue}}
\setkomafont{chapterentry}{\rmfamily\textbf} % Kapitelüberschriften im Inhaltsverzeichnis in Serifenschrift
...
\setlength{\parskip}{0.5\baselineskip}  % Standard Absatzendeabstand
...
\newtcolorbox{chapterbox}[1][]{
    ...
    width=\textwidth,
    arc=0pt,
    left=12pt, right=0pt, top=2cm, bottom=2cm,
    valign=center,
    fontupper=\normalfont\huge\rmfamily\color{white},
    halign=left,
    sharp corners,
    interior style={top color=chapterlightblue, bottom color=chapterdarkblue},
    before skip=0pt,
    after skip=18pt,
    parbox=false,
    #1
...
\pagestyle{plain}  % Inhaltsverzeichnis mit römischen Seitenzahlen, aber ohne Kopfzeile
\tableofcontents   % Inhaltsverzeichnis
\clearpage         % Manueller Seitenumbruch nach Inhaltsverzeichnis
...
\begin{figure}[ht] % [htbp] sind Platzierungsoptionen: h=h
    \centering % Zentriert die Abbildung auf der Seite
    \includegraphics[width=0.6\textwidth]{Fotos/ChristophMariaHerbst.jpg}
...
% \vspace*{-5\baselineskip} % Stärkerer negativer Abstand für chapterbox
% \begin{chapterbox}
%     Die ersten Jahre
% \end{chapterbox}

\thispagestyle{scrheadings} % Wichtig für eine Kopfzeile auf der ersten Seite des Kapitels
...
\begin{figure}[ht]
    \centering
    \fcolorbox{rahmenlinie}{white}{\includegraphics[width=1\textwidth]{Fotos/marius_und_rudi.jpg}}
...
\begin{tcolorbox}[
    enhanced,
    breakable,
    colframe=rahmenlinie,      % Rahmenfarbe wie bisher
    colback=white,             % Hintergrundfarbe
    left=12pt, right=12pt,     % Innenabstände
    top=12pt, bottom=12pt,     % Innenabstände
    boxrule=0.3pt,             % Rahmenstärke
    arc=8pt                    % Eckenradius (optional)
]
\small\sffamily
...
\begin{figure}[ht]
    \centering
    \fcolorbox{rahmenlinie}{white}{\includegraphics[width=1\textwidth]{Fotos/artillerie.jpg}}
...
\begin{figure}[ht]
    \centering
    \fcolorbox{rahmenlinie}{white}{\includegraphics[width=1\textwidth]{Fotos/grundschule_01.jpg}}
...
\begin{figure}[ht]
    \centering
    \fcolorbox{rahmenlinie}{white}{\includegraphics[width=1\textwidth]{Fotos/grundschule_02.jpg}}
...
\begin{figure}[H]
    \raggedright
    \fcolorbox{rahmenlinie}{white}{\includegraphics[width=\textwidth]{Fotos/evangelisches_pfarrzentrum.jpg}}
...
\begin{figure}[H]
    \raggedright
    \fcolorbox{rahmenlinie}{white}{\includegraphics[width=\textwidth]{Fotos/katholisches_pfarrzentrum.jpg}}
...
\begin{figure}[ht]
    \raggedright
    \fcolorbox{rahmenlinie}{white}{\includegraphics[width=\textwidth]{Fotos/haus_in_hormersdorf.jpg}}
...
\begin{figure}[H]
    \raggedright
    \fcolorbox{rahmenlinie}{white}{\includegraphics[width=\textwidth]{Fotos/hormersdorf_collection.jpg}}
...
\begin{figure}[ht]
    \raggedright
    \fcolorbox{rahmenlinie}{white}{\includegraphics[width=\textwidth]{Fotos/zeltgemeinschaft_kinderpyramide.jpg}}
...
\begin{figure}[H]
    \raggedright
    \fcolorbox{rahmenlinie}{white}{\includegraphics[width=\textwidth]{Fotos/zeltgemeinschaft_collection.jpg}}
...
\begin{figure}[ht]
    \raggedright
    \fcolorbox{rahmenlinie}{white}{\includegraphics[width=\textwidth]{Fotos/new_york_collection.jpg}}
...
\begin{figure}[ht]
    \raggedright
    \fcolorbox{rahmenlinie}{white}{\includegraphics[width=\textwidth]{Fotos/willkommen_marius.jpg}}
...
\begin{figure}[ht]
    \raggedright
    \fcolorbox{rahmenlinie}{white}{\includegraphics[width=\textwidth]{Fotos/leben_lachen_sterben_trauern.jpg}}
...
\begin{figure}[ht]
    \raggedright
    \fcolorbox{rahmenlinie}{white}{\includegraphics[width=\textwidth]{Fotos/spuren_hinterlassen.jpg}}
...
\begin{figure}[ht]
    \raggedright
    \fcolorbox{rahmenlinie}{white}{\includegraphics[width=\textwidth]{Fotos/snoezelen_raum.jpg}}
...
\begin{figure}[ht]
    \raggedright
    \fcolorbox{rahmenlinie}{white}{\includegraphics[width=\textwidth]{Fotos/weihnachtskarte.jpg}}
...
\begin{figure}[ht]
    \centering
    \fcolorbox{rahmenlinie}{white}{\includegraphics[width=\textwidth]{Fotos/hockenheim.jpg}}
...
\begin{figure}[ht]
    \raggedright
    \fcolorbox{rahmenlinie}{white}{\includegraphics[width=\textwidth]{Fotos/lese_und_entspannungszimmer.jpg}}
...
\begin{figure}[ht]
    \raggedright
    \fcolorbox{rahmenlinie}{white}{\includegraphics[width=\textwidth]{Fotos/zimmer_12.jpg}}
...
\begin{figure}[H]
    \raggedright
    \fcolorbox{rahmenlinie}{white}{\includegraphics[width=\textwidth]{Fotos/marius_und_peter_im_schwimmbad.jpg}}
...
\begin{figure}[H]
    \centering
    \fcolorbox{rahmenlinie}{white}{\includegraphics[width=\textwidth]{Fotos/raum_der_stille.jpg}}
...
\begin{figure}[H]
    \centering
    \fcolorbox{rahmenlinie}{white}{\includegraphics[width=\textwidth]{Fotos/x-chromosomal-rezessive-vererbung.jpg}}
    \caption{Die Wahrscheinlichkeit, dass eine Mutter, die Trägerin ist, einen kranken Sohn auf die Welt bringt, beträgt 50~\%. Ebenso hoch ist die Wahrscheinlichkeit, dass ihre Tochter Trägerin ist. \hfill Zeichnung: Peter Ebel}
    \label{fig:vererbung}
\end{figure}
...
\subsection{Warum Therapien so lange auf sich warten lassen}
...
\begin{figure}[H]
    \centering
    \fcolorbox{rahmenlinie}{white}{\includegraphics[width=\textwidth]{Fotos/befund_orthopädie.jpg}}
...
\begin{figure}[H]
    \centering
    \fcolorbox{rahmenlinie}{white}{\includegraphics[width=\textwidth]{Fotos/befund_humangenetik.jpg}}
...
\begin{figure}[H]
    \centering
    \fcolorbox{rahmenlinie}{white}{\includegraphics[width=\textwidth]{Fotos/skoliose_op_burger.jpg}}
...
\begin{figure}[H]
    \centering
    \fcolorbox{rahmenlinie}{white}{\includegraphics[width=\textwidth]{Fotos/skoliose_op_ vorher_nachher.jpg}}
...
\begin{figure}[H]
    \centering
    \fcolorbox{rahmenlinie}{white}{\includegraphics[width=\textwidth]{Fotos/marius_patrick_john.jpg}}
...
\addchap{Nachwort von Roland Penz}
\thispagestyle{scrheadings} % Wichtig, sonst erscheint die Kopfzeile nicht auf der ersten Seite des Kapitels
\normalsize
